...
import com.isentropy.accumulo.iterators.RowStatsTransformingIterator;

public class RowStatsMapper implements DerivedMapper{

	@Override
	public Class<? extends SortedKeyValueIterator<Key, Value>> getIterator() {
		return RowStatsTransformingIterator.class;
	}
