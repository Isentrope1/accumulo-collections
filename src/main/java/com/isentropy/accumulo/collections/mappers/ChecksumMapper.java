...
import com.isentropy.accumulo.iterators.MapChecksumAggregateIterator;

public class ChecksumMapper implements DerivedMapper{
	@Override
	public Class<? extends SortedKeyValueIterator<Key, Value>> getIterator() {
		return MapChecksumAggregateIterator.class;
	}
